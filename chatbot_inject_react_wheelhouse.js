       ...
       // Create and inject the style element
            ...
            showChatbotBtn.innerHTML = `
             <div style="height: 60px; width: 60px;  margin-right: -8px;">
              ...
              <span id="bounce-text" style="bottom:65px; width: 150px; right:10px; background-color: rgba(0,0,0,1); opacity: 0.7; padding:7px; border-radius: 50px; border-bottom-right-radius: 0px; position: absolute;">
...
//---------------------------------------
          ...
          // Create and inject the style element
            ...
            showChatbotBtn.innerHTML = `
              ...
              <span id="bounce-text" style="bottom:130px; width: 200px; right:10px; background-color: rgba(0,0,0,1); opacity: 0.7; padding:10px; border-radius: 50px; border-bottom-right-radius: 0px; position: absolute;">
                Need help? Talk to me!
              </span>
            `;
            document.body.appendChild(showChatbotBtn);
